...
\begin{table}[]
    ...
    \begin{tabular}{@{}cccccccc@{}}
        \toprule
        \multirow{2}{*}{} &
          \multicolumn{2}{c}{\begin{tabular}[c]{@{}c@{}}Preload of rivet\end{tabular}} &
          \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Applied \\ preload\\ $N_0$\end{tabular}} &
          \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Slip\\ resistance\\ $F_{sd}$\end{tabular}} &
          \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Net C-S yield\\ resistance\\ $F_{yd}$\end{tabular}} &
          \multirow{2}{*}{$\beta$} &
