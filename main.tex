...
\title{Study on Limit Strength of Hybrid Joint with Friction and Bearing Type Connection}
\subtitle{（摩擦接合と支圧接合を併用したハイブリッド継手の限界強度に関する研究）} % use \subtitle{} to remove it
\author{Chen Yu}
...
\input{AppendixA.tex}
\input{AppendixB.tex}
%\input{chapters/AppendixC} %Resin injection bolted joint
...
\singlespacing
\bibliography{package/references}
