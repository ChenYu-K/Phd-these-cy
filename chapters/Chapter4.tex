...
\begin{table}[ht]
    ...
    \begin{tabular}{@{}cccccccc@{}}
        \toprule
        \multirow{3}{*}{} &
          \multicolumn{2}{c}{\multirow{2}{*}{Preload of rivet (mm)}} &
          \multirow{3}{*}{\begin{tabular}[c]{@{}c@{}}Applied \\ preload\\ $N_0$\end{tabular}} &
          \multirow{3}{*}{\begin{tabular}[c]{@{}c@{}}Slip\\ resistance\\ $F_{sd}$\end{tabular}} &
          \multirow{3}{*}{\begin{tabular}[c]{@{}c@{}}Net C-S yield\\ resistance\\ $F_{yd}$\end{tabular}} &
          \multirow{3}{*}{$\beta$} &
          \multirow{3}{*}{\begin{tabular}[c]{@{}c@{}}Net C-S Ultimate\\ resistance\\ $F_{ud}$\end{tabular}} \\ 
          
          &  &  &       &        &        &      &       \\
          \cmidrule(lr){2-3}
          & 33 & 75 &       &        &        &      &       \\ \midrule
        RIVET & \multirow{4}{*}{45} & \multirow{4}{*}{78.5} & 
        ...
        RPALL & \multicolumn{2}{c}{-}                       & 215.5 & 391.11 & 190.59 & 2.05 & 315.3 \\ \bottomrule
    \end{tabular}
\end{table}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=\linewidth]{imgs/ch3/exp-pic-rp3.pdf}
...
\subsubsection*{Slip coefficient and pressure distribution}
\begin{itemize}
